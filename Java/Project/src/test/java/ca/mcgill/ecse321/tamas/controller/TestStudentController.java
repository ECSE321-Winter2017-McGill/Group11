...
public class TestStudentController {
	...
	public void testCreateStudent() {
		...
		assertEquals(0, student.getPreviousJobExperiences());
		
		//add previous experience to student
        ...
        student.addPreviousJobExperience(job);
        assertEquals(1, student.getPreviousJobExperiences());
