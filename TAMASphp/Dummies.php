...
$dpt -> addAllInstructor(array($teacher1, $teacher2, $teacher3));

$allTeachers = $dpt -> getAllInstructors();

$course1 = new Course("ECSE321", "ISE", "W2017", "3", "0", "2", "9", "60", "2", "5", "11.75", "11.75", "60", array($allTeachers[0][0]));
$course2 = new Course("ECSE323", "DSD", "W2017", "5", "7", "2", "15", "300", "6", "5", "11.75", "11.75", "100", array($allTeachers[0][1]));
$dpt -> addAllCourse(array($course1, $course2));

$allCourses = $dpt -> getAllCourses();

$myCourse = $allCourses;

$job1 = new Job("TA", "2017-07-21", $myCourse[0][0]);
$job2 = new Job("Grader", "2017-07-21", $myCourse[0][0]);
$job3 = new Job("TA", "2017-07-21", $myCourse[0][1]);
$job4 = new Job("Grader", "2017-07-21", $myCourse[0][1]);

$dpt -> addAllJob(array($job1, $job2, $job3, $job4));
